...
def draw_acc_curves(short_result_file_names):
    ...
    method_title = ['FedAvg', 'FedAvg-0.7', 'FedProx-mu_0.07', 'Scaffold-lr_0.3']
...
if __name__ == "__main__":
    ...
    short_result_file_name =  'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedAvg/short_result.txt'
    short_result_file_name2 = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedAvgM-0.7/short_result.txt'
    short_result_file_name3 = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedProx-0.07/short_result.txt'
