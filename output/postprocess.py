...
if __name__ == "__main__":
    ...
    short_result_file_name = 'output/20news-roberta-lora-dirichlet_label_uni-0.05-10-FedAvg/short_result.txt'
    short_result_file_name2 = 'output/20news-roberta-lora-dirichlet_label_uni-0.05-10-FedProx-0.1/short_result.txt'
