...
if __name__ == "__main__":
    ...
    short_result_file_name = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedAvg-219/short_result.txt'
    short_result_file_name2 = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedProx-0.07-original/short_result.txt'
    short_result_file_name3 = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-FedAvgM-0.7/short_result.txt'
    short_result_file_name4 = 'output/20news-roberta-lora-dirichlet_label_uni-0.1-10-Scaffold-0.3/short_result.txt'
    ...
    file_list = [short_result_file_name, short_result_file_name2, short_result_file_name3, short_result_file_name4, short_result_file_name5]
